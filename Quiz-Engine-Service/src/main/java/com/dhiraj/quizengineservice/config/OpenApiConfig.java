...
@OpenAPIDefinition(
        info = @Info(
                ...
                termsOfService = "https://www.brainbuzz.com/terms" // todo: add terms of service after deployment
        ),
        servers = {
                @Server(
                ...
                @Server(
                        ...
                        url = "https://www.brainbuzz.com" // todo: add production server url after deployment
                )
        }
//        security = {
//                @SecurityRequirement(
